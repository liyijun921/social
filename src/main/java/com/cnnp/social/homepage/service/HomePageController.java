...
public class HomePageController {
    ...
    public
    @ResponseBody
    List<HomePageInfoDto> view(@PathVariable("userid") String userid) {
    ...
    public
    @ResponseBody
    List<HomePageArticlecatDto> viewColumn(@RequestParam long hpid) {
    ...
    public
    @ResponseBody
    List<HomePageFormDto> viewForm(@RequestParam long hpid) {
    ...
    public
    @ResponseBody
    List<HomePageStyleDto> viewStyle(@PathVariable("hpid") long hpid) {
    ...
    public
    @ResponseBody
    List<HomePageInfoAllDto> viewHpall(@PathVariable("hpid") long hpid) {
    ...
    public
    @ResponseBody
    List<HomePageIDNameDto> viewFormall() {
